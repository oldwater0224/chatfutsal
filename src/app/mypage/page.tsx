    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-14 pb-20 px-4">
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          <Link href="/mypage/matches" className="bg-white rounded-lg p-4 shadow-sm text-center hover:bg-gray-50">
            <p className="text-2xl font-bold text-green-600">{upcomingMatchCount}</p>
            <p className="text-sm text-gray-500">예정된 매치</p>
          </Link>
          <Link href="/chat" className="bg-white rounded-lg p-4 shadow-sm text-center hover:bg-gray-50">
